                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLevel" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('level.create') }}">Add Level</a>
                                    <a class="nav-link" href="{{ route('level.index') }}">View Level</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsecity" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('city.create') }}">Add City</a>
