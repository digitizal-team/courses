          ...
          <div class="row">
            <div class="col-md-6 pt-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" value="{{ $course->name }}" name="name" placeholder="Name">
              </div>
            </div>
            <div class="col-md-6 pt-3">
              <div class="form-group">
                ...
                <select  class="form-control" id="level" name="level"  placeholder="Select level">
                  ...
                  <option value="{{ $item->id }}" {{ $course->name == $item->name ? 'selected' : '' }}>{{ $item->name }}</option>
                  @endforeach
                </select>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 pt-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="time" value="{{ $course->time }}" name="time" placeholder="">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6 pt-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="maxsize" value="{{ $course->class_size_max }}" name="maxsize" placeholder="">
              </div>
            </div>
            <div class="col-md-6 pt-3">
              <div class="form-group">
                <label for="exampleFormControlInput1">class size (min)</label>
                <input type="text" class="form-control" id="minsize" value="{{ $course->class_size_min }}" name="minsize" placeholder="">
              </div>
            </div>
          </div>
          <div class="row">
